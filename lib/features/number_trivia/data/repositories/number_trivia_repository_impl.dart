...
typedef _NumberTriviaType = Future<NumberTriviaModel> Function();
class NumberTriviaRepositoryImpl implements NumberTriviaRepository {
  ...
  Future<Either<Failure, NumberTrivia>> _getTrivia(
      _NumberTriviaType triviaDataSourceAction) async {
    if (await networkInfo.isConnected) {
      try {
        final remoteTrivia = await triviaDataSourceAction();
